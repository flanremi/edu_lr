...
SCRIPT_DIR = Path(__file__).parent  # data_preprocess/NeurIPS2020
PROJECT_ROOT = Path(__file__).parent.parent.parent
MAP_PATH = SCRIPT_DIR / "result/data/map.pkl"
TOTALDATA_PATH = SCRIPT_DIR / "result/data/TotalData.csv"
RESPONSE_LOGS_PATH = SCRIPT_DIR / "data/merged_data_V4.csv"
QUESTIONS_PATH = SCRIPT_DIR / "data/data_refined.xlsx"
OUTPUT_PATH_PROJECT = PROJECT_ROOT / "data/NeurIPS2020" / OUTPUT_FILENAME
OUTPUT_PATH_LOCAL = SCRIPT_DIR / "result/embedding" / OUTPUT_FILENAME
# ================================================
